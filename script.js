...
const OPPORTUNITIES = [
  {name:"Index fund shares", cost:2000, cashflow:22, category:"stock",
  ...
  {name:"Rental duplex", cost:15000, cashflow:180, loanAmount:60000, loanPayment:420, category:"realestate",
  ...
  {name:"Vending machine route", cost:4000, cashflow:70, category:"business",
  ...
  {name:"Government bond", cost:1000, cashflow:6, category:"bond",
  ...
  {name:"Friend's coffee cart franchise", cost:6000, cashflow:95, category:"business",
  ...
  {name:"Growth stock, no cashflow yet", cost:2500, cashflow:0, capitalGainOnly:true, saleMultiplier:1.8, category:"stock",
  ...
  {name:"Peer-to-peer lending fund", cost:3000, cashflow:45, category:"bond",
  ...
  {name:"Self-storage units", cost:8000, cashflow:110, loanAmount:20000, loanPayment:230, category:"realestate",
  ...
  {name:"Royalties on a course you made", cost:1500, cashflow:35, category:"business",
  ...
  {name:"Local laundromat", cost:9000, cashflow:140, category:"business",
  ...
  {name:"Suburban rental house", cost:18000, cashflow:210, loanAmount:70000, loanPayment:480, category:"realestate",
   body:"A three-bedroom house in a quiet suburb, rented out to a family. Cash down, mortgage for the rest, same setup as the duplex but a bigger property.",
   lesson:"Bigger property, bigger loan, bigger monthly cashflow, but also a bigger hole if it sits empty between tenants. Scale cuts both ways, it doesn't just make good deals better."},
  {name:"Beachside vacation rental", cost:22000, cashflow:260, loanAmount:85000, loanPayment:560, category:"realestate",
   body:"A small holiday unit you list short term instead of renting long term. Higher rent per night, but the income swings with the season.",
   lesson:"Short-term rentals can pay more than a regular lease, but the income is lumpier, some months are packed, others are empty. Higher potential return usually comes with less predictability, not just more money for free."},
  {name:"Small apartment block", cost:35000, cashflow:390, loanAmount:140000, loanPayment:940, category:"realestate",
   body:"A four-unit apartment building. Bigger purchase, bigger loan, but four rents coming in instead of one softens the blow if a single tenant moves out.",
   lesson:"One property with four tenants is more resilient than four separate one-tenant properties spread thin, since one vacancy only costs you a quarter of the rent instead of all of it. That's diversification showing up inside a single asset."},
  {name:"Retail strip shopfront", cost:12000, cashflow:150, loanAmount:40000, loanPayment:340, category:"realestate",
   body:"A small shopfront leased to a local business on a multi-year contract, rent paid straight to you every month.",
   lesson:"Commercial tenants often sign longer leases than residential ones, which means more predictable income, but it also means if that one business fails, you could be without a tenant for a while since replacing a commercial lease takes longer."},
  {name:"Farmland lease", cost:10000, cashflow:95, category:"realestate",
   body:"A block of farmland you don't work yourself, leased out to a local farmer who pays you rent each season.",
   lesson:"Land can produce income without a mortgage or a building on it at all. It won't make you rich fast, but it's about as low-maintenance as real estate gets."},
  {name:"Tech startup seed investment", cost:5000, cashflow:0, capitalGainOnly:true, saleMultiplier:2.4,
   body:"A small, early check into a startup a friend is building. No income at all for now, everything rides on the company surviving and growing.",
   lesson:"This is about as risky as this board gets. Most startups don't pay off, a few pay off enormously. That's a very different risk profile than a rental property, which is why people don't put their whole portfolio into deals like this."},
];
...
const DOODADS = [
  ...
  {name:"Water heater dies", amount:520, lesson:"Home repairs don't ask if it's a convenient month. This is a classic example of why the emergency fund needs to be sized to actual bad-case costs, not just a token amount."},
  {name:"Parking ticket", amount:90, lesson:"Small and avoidable, which almost makes it worse. These are the expenses that don't teach you anything except to pay closer attention next time."},
  {name:"Vet bill for a sick pet", amount:310, lesson:"Pets are a recurring expense most people underestimate until something goes wrong. It's worth budgeting for even when nothing's currently wrong."},
  {name:"Laptop dies right before a deadline", amount:600, lesson:"The cost of a bad-timed expense isn't just the dollar amount, it's the stress of needing the money right now instead of on your own schedule. That urgency is exactly what a cash cushion is meant to remove."},
  {name:"Wedding gift for a close friend", amount:150, lesson:"Social and family expenses are real and recurring, even though they rarely show up in a monthly budget until they land. Building a small buffer for them ahead of time beats scrambling."},
  {name:"Speeding ticket", amount:230, lesson:"Preventable expenses sting more precisely because you know there was nothing lucky or unlucky about it, it was a choice with a price tag attached after the fact."},
];

const MARKET_EVENTS = [
  {name:"Real estate boom", body:"Property values just jumped across town.",
   category:"realestate", amount:2, lesson:"Nothing you did caused this. Markets just move in cycles sometimes for reasons that have nothing to do with you. Trying to perfectly time these swings is way harder than just holding good stuff for a long time."},
  {name:"Market dip", body:"Stock prices fell 15 percent this week on the news.",
   category:"stock", amount:0.85, lesson:"It only actually costs you money if you sell during the dip. A lot of people panic and sell low, then buy back in later once it feels safe again, which is exactly backwards."},
  {name:"Interest rates rise", body:"The central bank raised interest rates.",
   category:null, amount:0, lesson:"Higher rates make borrowing more expensive across the board, which is why loan payments on new debt, and some existing variable rate loans, can creep up after news like this."},
  {name:"Local businesses are booming", body:"A wave of new foot traffic is hitting small businesses across town.",
   category:"business", amount:1.4, lesson:"Small local businesses can swing in value with things as ordinary as a new bus route or a nearby office opening. Boring assets aren't immune to booms either, they're just less talked about."},
  {name:"Recession worry hits property", body:"Buyers are getting nervous and property listings are sitting longer.",
   category:"realestate", amount:0.85, lesson:"Real estate is usually described as stable, and it mostly is, but it isn't immune to downturns. The tenants still pay rent either way though, which is why cashflow matters more than the paper value in the short term."},
  {name:"A hot sector rallies", body:"Investors are piling into growth stocks this quarter.",
   category:"stock", amount:1.3, lesson:"Rallies feel great to be in and terrible to have missed. The trouble is nobody rings a bell at the start, by the time it's obvious enough to be exciting, a lot of the gain has often already happened."},
  {name:"A local business struggles", body:"Rising costs are squeezing profit margins for small operators.",
   category:"business", amount:0.8, lesson:"Owning a real business means real operating costs can eat into what it pays you, unlike a bond or a stock where you're not exposed to day to day running costs directly."},
];
...
const CHANCE_EVENTS = [
  ...
  {name:"Identity theft scare", body:"Someone tried to open a card in your name. Sorting it out cost you time and a bit of money.",
   effect:"cash", amount:-260, lesson:"Financial literacy isn't just about growing money, it's also about protecting it. Monitoring your accounts regularly is a boring habit that occasionally saves you from a much bigger mess."},
  {name:"Won a small work bonus", body:"The team hit its target and everyone got a little extra this quarter.",
   effect:"cash", amount:350, lesson:"Bonuses tied to performance are still irregular income at the end of the day. Treating them like a raise you can rely on every year is how people overcommit their spending."},
  {name:"Car breaks down for good", body:"It's cheaper to replace it than keep repairing it at this point.",
   effect:"cash", amount:-700, lesson:"Big, lumpy expenses like a car replacement are exactly why some people keep a separate sinking fund just for predictable-but-irregular costs, on top of a normal emergency fund."},
  {name:"Landed a better-paying job", body:"You switched employers and negotiated a stronger starting salary.",
   effect:"salary", amount:550, lesson:"Switching jobs is one of the most reliable ways people raise their income faster than waiting on annual raises. It's not free though, it usually costs some stability and a learning curve."},
];
...
function showMarket(){
  ...
  if(ev.category){
    let touched=0;
    state.assets.forEach(a=>{ if(a.category===ev.category){ a.currentValue = Math.round(a.currentValue*ev.amount); touched++; } });
    const label = ev.category==='realestate' ? 'real estate' : ev.category;
    if(touched){
      extra = ev.amount>1 ? ` Your ${touched} ${label} asset(s) just went up in value.` : ` Your ${touched} ${label} asset(s) dropped on paper.`;
    } else {
      extra = ` You don't own any ${label} yet, so this one doesn't touch you.`;
    }
  }
  openModal({
...
const TERM_BANK = [
  ...
  {term:"Acceptance", def:"When the person receiving an offer agrees to it."},
  {term:"Bankruptcy", def:"Giving up control of your assets and finances, either by choice or by court order."},
  {term:"Barter", def:"Swapping one good for another instead of using money."},
  {term:"Book-up", def:"A charge account run by a trader."},
  {term:"Budget", def:"A list of income and likely expenses."},
  {term:"Capital", def:"Goods used to make other goods."},
  {term:"Caveat emptor", def:"A term meaning let the buyer beware."},
  {term:"Cheque", def:"A written order telling your bank to pay someone a set amount."},
  {term:"Commerce", def:"The buying and selling of goods and services between people and businesses."},
  {term:"Comparison shopping", def:"Checking several sellers to find the best deal."},
  {term:"Consideration", def:"Giving up something of value as part of a deal."},
  {term:"Consumer", def:"Someone who buys goods and services to meet needs and wants."},
  {term:"Consumer guarantees", def:"A set of rights and remedies for defective goods and services."},
  {term:"Contract", def:"A legally binding agreement."},
  {term:"Creditors", def:"People or businesses you owe money to."},
  {term:"Debt", def:"Money owed to someone else."},
  {term:"Disposable income", def:"Money left over to spend or save after income tax is taken out."},
  {term:"Distribution chain", def:"The path a product takes to reach the customer."},
  {term:"Drawee", def:"The bank that provides the cheque account."},
  {term:"Drawer", def:"The person who writes and signs a cheque."},
  {term:"Durable goods", def:"Items that can be used many times."},
  {term:"E-commerce", def:"Buying and selling goods and services over the internet."},
  {term:"EFTPOS", def:"Electronic funds transfer at the point of sale."},
  {term:"Electronic transfer", def:"Moving money between accounts online or by phone."},
  {term:"Fixed expenses", def:"Costs that stay the same each time, like rent."},
  {term:"Garnishee", def:"A court order letting a bank or employer take money from you to pay a creditor."},
  {term:"Goods", def:"Items you can see or touch."},
  {term:"Impulse buying", def:"Buying something without thinking about whether you actually need it."},
  {term:"Interest", def:"The price paid to use someone else's money."},
  {term:"Labour", def:"The human effort and skill used to produce goods and services."},
  {term:"Land", def:"Natural resources like forests, coal, and soil."},
  {term:"Liquidated", def:"When a company's assets are all sold off to pay its debts."},
  {term:"Mail order", def:"Buying products from a catalogue for delivery by mail."},
  {term:"Manufacturer", def:"A person or business that makes goods."},
  {term:"Money", def:"Anything with an agreed value that people accept as payment."},
  {term:"Needs", def:"Things necessary for survival, like food and water."},
  {term:"Non-durable goods", def:"Items that can only be used once."},
  {term:"Offer", def:"A proposal made to someone."},
  {term:"Online shopping", def:"Buying products over the internet."},
  {term:"Opportunity cost", def:"What you give up by choosing one option over another."},
  {term:"Payee", def:"The person who receives money from a cheque."},
  {term:"Price", def:"The amount a consumer is willing to pay for a good or service."},
  {term:"Redress", def:"To set something wrong right."},
  {term:"Retailer", def:"A business that sells products directly to consumers."},
  {term:"Rip-off", def:"To overcharge or cheat someone."},
  {term:"Scam", def:"An illegal business practice meant to deceive."},
  {term:"Sequestration order", def:"A Federal Court order declaring someone bankrupt."},
  {term:"Services", def:"Things done for you by other people."},
  {term:"Superannuation", def:"Money set aside during your working life for retirement."},
  {term:"Trade union", def:"A group that represents workers and pushes for better pay and conditions."},
  {term:"Unconscionable act", def:"An unreasonable, often illegal act by a seller."},
  {term:"Variable expenses", def:"Costs that change and don't happen on a fixed schedule."},
  {term:"Wants", def:"Things you'd like but don't need to survive."},
  {term:"Wholesaler", def:"Buys goods in bulk from manufacturers."},
  {term:"Writ of execution", def:"A court order letting an official seize and sell your property."},
];
