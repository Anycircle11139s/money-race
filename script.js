...
// Two quick minigames live on the "PLAY" space. Both are short, skill based,
// and pay out a cash bonus based on how well you actually do, not luck.
// They exist to make a couple of ideas (prioritizing bills, knowing the vocab)
// stick through repetition and a bit of time pressure, not more reading.

function showMinigame(){
  if(Math.random()<0.5) showBudgetBlitz();
  else showTermSprint();
}
